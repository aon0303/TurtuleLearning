...
| API 제공 | 로그인, 메뉴, 게시판 관련 REST API 제공 |
...
- 메뉴 이미지 URL 필드 확장 필요 → DTO/Service/Repository/Controller 연쇄 반영
- 레이아웃/스타일 충돌 → 글로벌 및 서브 네비 스타일 조정
- 잔여 콘텐츠(게임) 미반영 → 정적 자산 및 HTML 통합으로 마감
